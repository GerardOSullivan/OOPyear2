package LabSheetWeek4.exercise5;
...
public class TestBook {
    public static void main(String args[])
    {
        ...
        textArea.append(String.format("%-25s%-8s%-25s%-5s" ,"Title" ,"Price","ISBN","Pages"));
        ...
        textArea.append(String.format("\n\n%-25s%-8s%-25s%-5s" ,favouriteBook.getTitle() , String.format("%.2f",favouriteBook.getPrice()), favouriteBook.getISBN(),favouriteBook.getPages()));
        ...
        textArea.append(String.format("\n\n%-25s%-8s%-25s%-5s" ,leastFavouriteBook.getTitle() , String.format("%.2f",leastFavouriteBook.getPrice()), leastFavouriteBook.getISBN(),leastFavouriteBook.getPages()));
